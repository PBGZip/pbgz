"""
testtestusecase：FastqVariableLengthPipelineTest - variablelengthorderlistFASTQpipelinepipelinehandlemanagetesttest
...
class FastqVariableLengthPipelineTest(PBGZTestCase):
    def __init__(self):

        super().__init__("FastqVariableLengthPipelineTest")
        self.source_file = "variable_length_pipeline_test.fq"
        self.compressed_file = "variable_length_pipeline_test.fq.pbgz"
        self.decompressed_file = "variable_length_pipeline_test.fq.dec"
    ...
    def prepare_data(self):
        ...
        for i in range(num_reads):
            # IDexecution
            seq_id = f"@VAR_PL{i:06d} 1/1"
            
            # orderlistinsidecapacity：notsamelengthdegreeoffollowmachineorderlist
            bases = ''.join(random.choices('ATGCN', k=random.randint(25, 120)))
        ...
        # Addtesttestcommand：pipelinepipelineoutputinput，filefileoutputoutput
...
if __name__ == "__main__":
    test_case = FastqVariableLengthPipelineTest()
