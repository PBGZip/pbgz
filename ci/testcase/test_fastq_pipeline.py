"""
testtestusecase：FastqPipelineTest - FASTQfilefilepipelinepipelinecompresscompressdecompresscompresstesttest

testtestscenarioscenario：
- testtestFASTQfilefileThroughthroughUnixpipelinepipelinemethodformatadvanceexecutioncompresscompressdecompresscompresshandlemanage
- VerifyverifyFASTQformatformatdatadatawithstandardstandardUnixworktoolofconcurrentcapacityquality
- testtestGenerateobjectinformationinformationstudystandardstandardworkworkflowofcollectiongenerate
...
class FastqPipelineTest(PBGZTestCase):
    def __init__(self):

        super().__init__("FastqPipelineTest")
        self.source_file = "pipeline_test.fq"
        self.compressed_file = "pipeline_test.fq.pbgz"
        self.decompressed_file = "pipeline_test.fq.dec"
    ...
    def prepare_data(self):
        ...
        # Addcompresscompresstesttestcommand：pipelinepipelineoutputinput，filefileoutputoutput
