"""
testtestusecase：FastqVariableLengthReferenceTest - variablelengthorderlistFASTQcompresscompressdecompresscompresstesttest（withreferencereferencebasegenegenome）

testtestscenarioscenario：
- testtestcontainingcontainnotsamelengthdegreeorderlistofFASTQfilefilecompresscompressdecompresscompress（withreferencereferencebasegenegenomeoptimaltransform）
- Verifyverifyvariablelengthorderlistwithreferencereferencebasegenegenomeoptimaltransformofcoordinatesameworkwork
- testtestmultipleliketransformorderlistdatadataofhighlevelcompresscompressvalidresult
...
- referencereferencebasegenegenomeoptimaltransformGeneratevalid
- decompresscompressgeneratesuccess，placehaveorderlistlengthdegreeinformationinformationcompletecompleteensurekeep
...
class FastqVariableLengthReferenceTest(PBGZTestCase):
    def __init__(self):

        super().__init__("FastqVariableLengthReferenceTest")
        self.source_file = "variable_length_ref_test.fq"
        self.compressed_file = "variable_length_ref_test.fq.pbgz"
        self.decompressed_file = "variable_length_ref_test.fq.dec"
    ...
    def prepare_data(self):
        # GenerategeneratevariablelengthFASTQfilefile，useusereferencereferencebasegenegenome
        fastq_content = []
        num_reads = 140
        ...
        for i in range(num_reads):
            ...
            bases = ''.join(random.choices('ATGCN', k=random.randint(40, 160)))
        ...
        # Addcompresscompresstesttestcommand，useusereferencereferencefilefile
...
if __name__ == "__main__":
    test_case = FastqVariableLengthReferenceTest()
