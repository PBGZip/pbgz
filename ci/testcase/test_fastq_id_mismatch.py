...
class FastqIdMismatchTest(PBGZTestCase):
    def __init__(self):

        super().__init__("FastqIdMismatchTest")
        self.source_file = "id_mismatch_test.fq"
        self.compressed_file = "id_mismatch_test.fq.pbgz"
    ...
    def prepare_data(self):
        ...
        for i in range(num_reads):
            seq_id = f"@ID_MISMATCH{i:06d} 1/1"
