...
class FastqPipelineReferenceTest(PBGZTestCase):
    def __init__(self):

        super().__init__("FastqPipelineReferenceTest")
        self.source_file = "pipeline_ref_test.fq"
        self.compressed_file = "pipeline_ref_test.fq.pbgz"
        self.decompressed_file = "pipeline_ref_test.fq.dec"
...
if __name__ == "__main__":
    test_case = FastqPipelineReferenceTest()
