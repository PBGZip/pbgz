...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    --help)
      ...
      echo "Build Release-Profile version of PBGZ (optimized with debug symbols)"
      echo ""
      echo "Options:"
...
BUILD_DIR="$ROOT_DIR/build-$ARCH-$COMPILER-release-profile"
INSTALL_DIR="$ROOT_DIR/release-release-profile"
...
cd "$BUILD_DIR"
cmake -DCMAKE_BUILD_TYPE=Release-Profile \
