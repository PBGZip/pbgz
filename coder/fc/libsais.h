...
extern "C" {
    ...
    * @return the libsais context, NULL otherwise.
    */
    void * transform_init_omp(int32_t threads);
#endif
    ...
    * @return 0 if no error occurred, -1 or -2 otherwise.
    */
    int32_t optomp(const uint8_t * T, int32_t * SA, int32_t n, int32_t fs, int32_t threads);
#endif
    ...
    * @return The primary index if no error occurred, -1 or -2 otherwise.
    */
    int32_t optbwt_omp(const uint8_t * T, uint8_t * U, int32_t * A, int32_t n, int32_t fs, int32_t threads);
    ...
    * @return 0 if no error occurred, -1 or -2 otherwise.
    */
    int32_t optbwt_aux_omp(const uint8_t * T, uint8_t * U, int32_t * A, int32_t n, int32_t fs, int32_t r, int32_t * I, int32_t threads);
#endif

    /**
    * Creates the libsais reverse BWT context that allows reusing allocated memory with each untransform_* operation. 
    * In multi-threaded environments, use one context per thread for parallel executions.
    * @return the libsais context, NULL otherwise.
    */
...
#if defined(_OPENMP)
    /**
    * Creates the libsais reverse BWT context that allows reusing allocated memory with each parallel untransform_* operation using OpenMP. 
    * In multi-threaded environments, use one context per thread for parallel executions.
    * @param threads The number of OpenMP threads to use (can be 0 for OpenMP default).
    * @return the libsais context, NULL otherwise.
    */
